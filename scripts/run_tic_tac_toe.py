    ...
    def test(self):
        ...
        for _ in range(turns):
            ...
            if winner == -1:
                player2_win += 1
            self.simulator.reset()
        logger.info('%d games, player 1 winrate %.02f, player 2 winrate %.02f' % (turns, player1_win / turns, player2_win / turns))
...
if __name__ == '__main__':
    ...
    from scripts.simulator.simulator import Simulator
    import warnings
